function entradacero(a,b,ciy,cix,xi,t0)
...
subplot(2,1,1)
xi = 0;
plot(tiempo,0,'b','LineWidth',2)

hold on
y = matlabFunction(y);
plot(tiempo,y(tiempo),'r','LineWidth',2)
...
plot(tiempo,dy(tiempo),'g','LineWidth',2)

hold on
title('Primera y segunda derivada de la salida','FontWeight','bold','FontSize',16)
ddy = matlabFunction(ddy);
plot(tiempo,ddy(tiempo),'m','LineWidth',2)
